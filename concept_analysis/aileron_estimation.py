...
C_nr_rudder = -(c_n_beta_rudder+c_d0_rudder)*C_r_rudder*b_rudder*(1+3*taper_rudder)/(24*S_rudder)*10  # To be replaced by simulation result!

v_c_ng_rudder = - c_elevator / (V*Vh_V)
C_mq_elevator = -(c_m_a_elevator+c_d0_elevator)*C_r_elevator*b_elevator*(1+3*taper_elevator)/(24*S_elevator)*5 # To be replaced by simulation result!
...
b1_elevator = fsolve(Solver_elevator, initial_value, args = (v_c_ng_rudder ,C_mq_elevator ,d_e_elevator,cm_delta_e_elevator))

print('The position of the starting point of the ailelron is:', b1_wing[0], 'The length of the aileron is:',b2_wing-b1_wing[0])
